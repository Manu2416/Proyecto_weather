async function enviar(ruta) {
    ...
    async function enviar_temps(ruta) {
        // 1. Primero guardamos el ELEMENTO en la variable
        const statusDiv = document.getElementById('status_dbi');
        
        // 2. Luego cambiamos su contenido
        statusDiv.innerHTML = '<span class="text-warning">⏳ Actualizando... esto puede tardar unos segundos.</span>';
